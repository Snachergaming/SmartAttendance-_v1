  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.user) {
        ...
        if (profileError) {
          console.error('Admin profile lookup failed', profileError, { userId: data.user.id });
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            >
              <div className="relative">
                <div className="w-16 h-16 rounded-full bg-primary/10 text-primary flex items-center justify-center ring-2 ring-primary/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  type="email"
                  placeholder="admin@ritppune.com"
                  value={email}
